...
public class Local_List_Goods extends Activity {
	...
	Context context = Local_List_Goods.this;
	...
	private String webLocalRequest() {
		...
		try {
			...
			bw.write("json={\"filter\":{\"longitude\":\"" + longitudeXiann + "\",\"latitude\":\"" + latitudeXiann +"\",\"dest_id\":\"603\",\"category_id\":\"20\"},\"pagination\":{\"count\":10,\"page\":1}}");
			bw.flush();
	...
	private LocalData parseJsonToModel(String jsonString) {
		try {
			...
			for (int i = 0; i < array.length(); i++) {
				...
				branch.setApp_cut_price_desc(obj.getString("app_cut_price_desc"));
