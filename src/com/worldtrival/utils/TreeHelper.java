...
{
	private static int[] imgid = { R.drawable.appicon_documents_consult, R.drawable.appicon_payment_consult,R.drawable.appicon_appointment_consult,R.drawable.appicon_red_pocket_consult };
	/**
	 * 将用户的数据转化为树形数据
	 * 
	 * @param datas
	...
	private static void setNodeIcon(Node n)
	{
		...
		if (n.getChildren().size() > 0)
		{
			switch (n.getId()) {
			case 1:
				n.setIcon(R.drawable.appicon_documents_consult);
				break;
			case 2:
				n.setIcon(R.drawable.appicon_payment_consult);
				break;
			case 3:
				n.setIcon(R.drawable.appicon_appointment_consult);
				break;
			case 4:
				n.setIcon(R.drawable.appicon_red_pocket_consult);
				break;
			default:
				break;
			}
